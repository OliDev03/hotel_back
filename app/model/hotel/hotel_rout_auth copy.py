...
# if not CRYPTO_KEY:
#     raise RuntimeError("La variable d'environnement CRYPTO_KEY doit être définie")
...
#         raise HTTPException(
#             status_code=status.HTTP_400_BAD_REQUEST,
#             detail="Provider email non supporté"
#         )
...
#         "email_address": data.email_address,
#         "password": get_password_hash(data.password),
#         "imap_config":get_imap_host(data.email_address),
#         "smtp_config":get_smtp_host(data.email_address),
#         "created_at": datetime.now().isoformat(),
#         "updated_at": datetime.now().isoformat(),
#         "last_sync": datetime.now().isoformat()
#     }
